 ...
 *      and is supplied by the caller (default: `"keyquill-relay-v1"`).
 *   4. All messages encrypted with AES-GCM using random 12-byte IVs.
 */

const ECDH_CURVE = "P-256";
const DEFAULT_HKDF_LABEL = "keyquill-relay-v1";
 ...
 *
 * `hkdfLabel` MUST match on both sides (default `"keyquill-relay-v1"`).
